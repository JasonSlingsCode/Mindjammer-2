...
public class SystemGeneratorScript : MonoBehaviour
{
    ...
    public void StellarBodyAge(int stellarBodyAgeSelection)
    {
        switch (stellarBodyAgeSelection)
        {
            case 0: // UNKNOWN
                localSystemAspects.SBA_Value = stellarBodyAgeSelection;
                localSystemAspects.stellarBodyAge = SBA_Menu.captionText.text + " ";
                break;
            case 1: // EXTREMELY YOUNG
                localSystemAspects.SBA_Value = stellarBodyAgeSelection;
                localSystemAspects.stellarBodyAge = SBA_Menu.captionText.text + " ";
                break;
            case 2: // VERY YOUNG
